...
const slides = [
    {
        ...
        img: "https://images.pexels.com/photos/16153361/pexels-photo-16153361.jpeg?auto=compress&cs=tinysrgb&w=600",
        url: "/",
    ...
    },
    {
        ...
        description: "Sale! Up to 50% off!",
        img: "https://images.pexels.com/photos/20763352/pexels-photo-20763352.jpeg?auto=compress&cs=tinysrgb&w=600",
        url: "/",
    ...
    },
    {
        ...
        description: "Sale! Up to 50% off!",
        img: "https://images.pexels.com/photos/16259241/pexels-photo-16259241.jpeg?auto=compress&cs=tinysrgb&w=600",
        url: "/",
                ...
                {slides.map((slide) => (
                    <div className={`${slide.bg} w-screen h-full flex flex-col gap-16 xl:flex-row`} key={slide.id}>
                        ...
                        <div className="h-1/2 xl:w-1/2 xl:h-full flex flex-col items-center justify-center gap-8 2xl:gap-12 text-center">
                            <h2 className=" text-lg lg:text-3xl 2xl:text-5xl">{slide.description}</h2>
